...
QT_MOC_LITERAL(1, 16, 10), // "LOGCONSOLE"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 7), // "strText"
QT_MOC_LITERAL(4, 36, 22), // "CONSOLECOLOURS::colour"
QT_MOC_LITERAL(5, 59, 3) // "col"

    },
    "ImageProcessing\0LOGCONSOLE\0\0strText\0"
...
void ImageProcessing::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ImageProcessing::*_t)(QString , CONSOLECOLOURS::colour );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageProcessing::LOGCONSOLE)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ImageProcessing::LOGCONSOLE(QString _t1, CONSOLECOLOURS::colour _t2)
{
